...
public class Kitchen {
    ...
    private boolean tinfoilCollected = false; // Track if tinfoil is collected
    ...
    public boolean explore(User user){
        ...
        if(choice.equalsIgnoreCase("yes")){
            System.out.println("You walk towards it and open it... \n" +
                    "The smell of rotten meats fills the room and flies emerge from the cooler. \n" +
            ...
            if(choice.equalsIgnoreCase("yes")) {
                System.out.println("You can only pick one can for now. \n" +
                        "Which one would you take? (corn/fruit/pasta/marshmallows/spam)");
                choice = scanner.next();
    ...
    // Method to explore the kitchen location on Day 5
    public boolean exploreDay5(User user) {
        ...
        if (choice.equalsIgnoreCase("yes")) {
            ...
            tinfoilCollected = true; // Mark tinfoil as collected
    ...
    // Method to check if tinfoil is collected
    public boolean hasTinfoil() {
        return tinfoilCollected;
    }
}
